...
dummyGraph.addNode(0, { label: "0", x: 0, y: 1, size: 5, color: "rgba(255, 0, 0, 0.1)" });
...
dummyGraph.mergeEdge(0, 1, { color: "blue", type: "line", size: 10 });
dummyGraph.mergeEdge(1, 0, { color: "blue", size: 10 });
