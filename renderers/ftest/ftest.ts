...
dummyGraph.mergeEdge(0, 0, { color: "black", type: "loop", size: 25 });
dummyGraph.mergeEdge(0, 0, { color: "black", type: "loop", size: 20 });
dummyGraph.mergeEdge(0, 0, { color: "black", type: "loop", size: 15 });
dummyGraph.mergeEdge(0, 0, { color: "black", type: "loop", size: 10 });
